...
import { ChannelDoc, ChatMessagePayload, 
         ChatMessageStatus, ChatMessageStatusPayload, 
         ChatReceiverPayload, isChannelDoc, Message, 
         NewActiveChannelPayload } from "../../types/ChatTypes.js";
...
export const handleChatMessage = async (payload: ChatMessagePayload, byUserId: Types.ObjectId) => {
