...
const LogoSvg = () => {
    return (
        <svg className = "logo-svg" viewBox="0 0 317 210" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="96.7731" y="5" width="70.48" height="188.697" transform="rotate(28.0637 96.7731 5)" />
            <rect x="159" y="38.097" width="70.36" height="188.697" transform="rotate(-28.06 159 38.097)" />
