...
export enum ChatActionTypes {
    ...
    MOVE_ACTIVE_CHANNEL_FRONT = "MOVE_ACTIVE_CHANNEL_FRONT"
}
...
export const moveChannelToFrontAction = (channelId: string): ChatAction => ({
    type: ChatActionTypes.MOVE_ACTIVE_CHANNEL_FRONT,
    payload: channelId
})